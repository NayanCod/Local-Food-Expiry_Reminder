  ...
  <div className="max-w-[85rem] flex flex-col justify-center items-center gap-y-6 mx-auto px-4 sm:px-6 lg:px-8 py-24">
    ...
    <div className="max-w-3xl text-center mx-auto">
      <h1 className="font-extrabold text-gray-100 text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight">
        Never Let Your Item <br /> Go to Waste
      </h1>
    </div>
    ...
    <div className="text-center">
      <Link
        ...
        className="inline-flex items-center gap-x-3 bg-white text-blue-600 text-sm font-semibold shadow-md rounded-full px-6 py-3 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 transition duration-300"
      >
        Get started
        <svg
          className="w-5 h-5"
